...
import { Reservas, Personas, Espacios, Docentes, Administrativo } from 'app/models';
...
export class ReservacionesComponent implements OnInit {
  ...
  @ViewChild('mdmodald') modal: any;
  @ViewChild('mdrEservad') modald: any;

  @ViewChild('mdDetalle') detallemodal: any;
  ...
  ngOnInit() {
    ...
    this.administrativo = new Array<Administrativo>();
    this.getPersonas();
    this.getDocentes();
    this.getEspacios();
  }
  ...
  getResponsable(idresponsable): string {
    let nestudiante = this.personas.find(cat => cat.id_persona == idresponsable);
    let ndocente = this.docente.find(cat => cat.id_docente == idresponsable);
    let nadministrativo = this.administrativo.find(cat => cat.id_administrativo == idresponsable);
    if (nestudiante) {
      return "Est: " + nestudiante.nombre;
    }
    else if (ndocente != null) {
      return "Doc: " + ndocente.nombre_doc;
    } else if (nadministrativo)
      return "P.A " + nadministrativo.nombre_adm;
  }
