...
import {Espacios, TipoEspacio } from 'app/models';
...
export class EspacioComponent implements OnInit {
  ...
  getFila(sitio){
    this.eSpacios = new Espacios();
    this.eSpacios = Object.assign({}, sitio)
    this.modal.show();
  }
  cancelar(){
    this.eSpacios = Object.assign({}, new Espacios());
    $('#frmsitio').bootstrapValidator('resetForm', true);
    this.modal.hide();
  }
